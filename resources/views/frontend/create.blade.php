        ...
        <div class="card">
            ...
            <form action="{{ route('facturas.store') }}" method="post">
                ...
                <div class="form-group input-group">
                    ...
                    <input placeholder="Ingresa el numero de factura" type="number" class="form-control @error('NumeroDeFactura') is-invalid @enderror" id="NumeroDeFactura" name="NumeroDeFactura" value="{{ old('NumeroDeFactura') }}">
                    </div> 
                ...
                <div class="form-group input-group">
                    ...
                    <input placeholder="Fecha de Compra" type="text" class="form-control @error('FechaDeCarga') is-invalid @enderror" id="FechaDeCarga" name="FechaDeCarga" value="{{ old('FechaDeCarga', $factura->FechaDeCarga ?? '') }}" onfocus="(this.type='date'); this.min='2024-02-01';this.max='2024-12-31';"  >
                ...
                <div>
                @if ($errors->has('PuntoDeVenta'))
                        <span class="text-danger">{{ $errors->first('PuntoDeVenta') }}</span>
                @endif
                </div>
                ...
                <div class="center">                 
                    ...
                    <div class="input-group numberinput four">  
                        ...
                        <div>
                @if ($errors->has('PuntosDeFactura'))
                        <span class="text-danger">{{ $errors->first('PuntosDeFactura') }}</span>
                @endif
                </div>
                    </div>
                    </div>                            
                <div class="buttonform">
                        <button style="font-size:14px !important" type="submit" class="offset-md-5 btn btn-primary submitbill"> AÑADIR FACTURA</button>
