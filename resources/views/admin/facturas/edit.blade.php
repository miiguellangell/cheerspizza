        ...
        <div class="card">
            ...
            <form action="{{ route('facturas.update', $facturas->id) }}" method="post">
                ...
                <div class="form-group input-group">
                    ...
                    <input  placeholder="Numero de cliente"  type="text" class="form-control @error('IdCliente') is-invalid @enderror" id="IdCliente" name="IdCliente" value="{{ $facturas->IdCliente }}">                                     
                </div> 
                <div>
