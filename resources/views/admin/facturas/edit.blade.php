        ...
        <div class="card">
            ...
            <form action="{{ route('facturas.update', $factura->id) }}" method="post">
                ...
                <div class="form-group input-group">
                    ...
                    <input placeholder="Fecha de Compra"  type="text" class="form-control @error('FechaDeCarga') is-invalid @enderror" id="FechaDeCarga" name="FechaDeCarga" value="{{ $factura->FechaDeCarga }}" onblur="(this.type='text')" onfocus="(this.type='date')" >
